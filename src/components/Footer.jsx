      ...
      <div className="max-w-7xl mx-auto py-16 px-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <ul className="space-y-2">
            ...
            <li>
              <Link to="/rooms" className="text-gray-400 hover:text-amber-500 transition duration-300">Accommodations</Link>
            </li>
            <li>
              <Link to="/dining" className="text-gray-400 hover:text-amber-500 transition duration-300">Dining</Link>
            </li>
            <li>
              <Link to="/spa" className="text-gray-400 hover:text-amber-500 transition duration-300">Spa & Wellness</Link>
            </li>
            <li>
              <Link to="/experiences" className="text-gray-400 hover:text-amber-500 transition duration-300">Experiences</Link>
            </li>
            <li>
              <Link to="/gallery" className="text-gray-400 hover:text-amber-500 transition duration-300">Gallery</Link>
            </li>
          </ul>
        </div>
      ...
      <div className="bg-gray-950 py-6">
        <div className="max-w-7xl mx-auto px-4 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-500 text-sm">
            &copy; {currentYear} Residencia del Hamor. - Den John Emmanuel Cabria
          </p>
